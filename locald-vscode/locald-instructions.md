...
- Before browser or testing work that requires a live service, use the locald ensure-ready or open tool. It waits for authoritative readiness and returns semantic URLs.
