...
> ⚠️ **Experimental**: CNB builds are experimental and available only in nightly builds. Expect changes.
>
...
Once built, `locald` needs to know how to start your application. It supports auto-detection of the start command from the buildpack metadata. See [Process Types & Start Commands](../features/process-types.md) for details.
