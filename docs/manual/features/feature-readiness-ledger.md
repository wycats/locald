...
| CNB builds (`locald build`, `[services.*.build]`)         | Experimental          | docs/rfcs/0049-composable-cnb-library.md; docs/rfcs/0056-extract-build-environment.md                | locald-docs: experimental/builds                              | Experimental until the failure modes and surfaces are fully stabilized.                       |
...
| Legacy Docker daemon integration                          | Experimental / Legacy | docs/manual/roadmap/docker-integration.md; docs/rfcs/0079-unified-service-trait.md                   | locald-docs: reference/integrations                           | Must not be required for the default container story.                                         |
