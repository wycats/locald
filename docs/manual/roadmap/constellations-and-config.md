# Design: Constellations & Configuration Philosophy

> **Core focus**: Keep the default project flow simple; advanced grouping is optional.
...
- **Registration**: implicit on `locald up`.
