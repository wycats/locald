...
1.  **Analyze the Project Context**: Read workflow and system axioms via `exo axiom list --scope workflow` and `exo axiom list --scope system`, plus \`${workspaceFolder}/docs/vision.md\`. Understand the "Exosuit Way" (Generative, Living Context, User-in-the-Loop).
