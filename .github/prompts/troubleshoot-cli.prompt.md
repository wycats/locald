...
You are attempting to modify a managed Exosuit state surface (for example phase state in SQLite, SQL persistence artifacts, or protected generated views) but cannot find the appropriate `exo` command.
...
**Context**: I was trying to [Action] in [State Surface or Artifact].
