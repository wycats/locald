---
title: Ephemeral Containers (Experimental)
description: Run one-off OCI containers with locald.
---

> **Experimental**: Ephemeral containers are experimental and available only in nightly builds. Expect changes.
>
> **Core focus**: This is an optional capability, not part of the primary launch flow.
