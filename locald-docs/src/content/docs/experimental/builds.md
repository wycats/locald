---
title: Cloud Native Builds (Experimental)
description: Opt-in builds using Cloud Native Buildpacks.
---

> **Experimental**: CNB builds are experimental and available only in nightly builds. Expect changes.
>
> **Core focus**: Builds are optional and should not block the default host execution story.
...
This feature is part of the **Container Execution** mode. See [Execution Modes](/experimental/execution-modes/) for a comparison with the default Host Execution.
...
Once built, `locald` needs to know how to start your application. It supports auto-detection of the start command from the buildpack metadata. See [Process Types & Start Commands](/reference/service-types/) for details.
