---
title: Execution Modes (Experimental)
description: Host execution is default; container execution is experimental.
---

> **Experimental**: Container execution and builds are experimental and available only in nightly builds. Expect changes.
>
> **Core focus**: Host execution remains the primary launch story.
...
See [Cloud Native Builds](/experimental/builds/) for more details.
